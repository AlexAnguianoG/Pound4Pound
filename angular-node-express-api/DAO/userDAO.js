...
let createUser = (dataToSet, callback) => {
    ...
    dbConfig.getDB().query("INSERT INTO `user`  ( `Username`, `Password`, `Email`, `role`, `isActive`, `Age`, `Weight`, `Height`)  VALUES ('"+dataToSet.Username+"','"+dataToSet.Password+"', '"+dataToSet.Email+"','"+dataToSet.Role+"', '1', '"+dataToSet.Age+"', '"+dataToSet.Weight+"', '"+dataToSet.Height+"');", callback);
